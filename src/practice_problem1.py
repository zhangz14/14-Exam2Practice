...
class Box(object):
    ...
    def append_string(self, additional_contents):
        ...
        if len(self.contents + additional_contents) > self.volume:
            ...
            for k in range(len(additional_contents) - spare_spaces):
                extra = extra + additional_contents[spare_spaces + k]
            return extra
        else:
    ...
    def double(self):
        ...
        #    ** TWO **   LINES OF CODE.
        ################################################################
        if len(self.contents + self.contents) > self.volume:
            extra = ''
            spare_spaces = self.volume - len(self.contents)
            for k in range(len(self.contents) - spare_spaces):
                extra = extra + self.contents[spare_spaces + k]
            for k in range(spare_spaces):
